...
namespace FretCloudAPI.Controllers
{
    ...
    public class IncoTermMasterController : Controller
    {
        private readonly FretCloudDBContext _context;

        public IncoTermMasterController(FretCloudDBContext context)
        {
            _context = context;
        }
        ...
        {
            var icoterm = await _context.IncoTerrmMasters.ToListAsync();
            return Ok(icoterm);
        }
