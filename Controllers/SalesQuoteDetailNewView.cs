...
namespace FretCloudAPI.Controllers
{
    ...
    public class SalesQuoteDetailNewViewController : Controller
    {
        private readonly FretCloudDBContext _context;

        public SalesQuoteDetailNewViewController(FretCloudDBContext context)
        {
            _context = context;
        }
        ...
        //     var salesquotenew = _context.SalesQuotesDetailViews
        ...
        // {
        //     var S = await _context.SalesQuotesDetailView.ToListAsync();
        //     return Ok(s);
        // }
        ...
        public async Task<IActionResult> GetCompany(int id)
        {
            ...
            var cc = await _context.SaleQuoteDetailNewdisplayViews.Where(x => x.SalesQuoteId == id).ToListAsync();
            return Ok(cc);
        }
//         [HttpPost()]
