...
namespace FretCloudAPI.Controllers
{
    ...
    public class SalesQuoteDetailViewController : Controller
    {
        private readonly FretCloudDBContext _context;

        public SalesQuoteDetailViewController(FretCloudDBContext context)
        {
            _context = context;
        }
        ...
        // {
        //     var DemoCompany = await _context.SalesQuotesDetailViews.ToListAsync();
