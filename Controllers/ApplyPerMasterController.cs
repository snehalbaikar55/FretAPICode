...
namespace FretCloudAPI.Controllers
{
    ...
    public class ApplyPerMasterController : Controller
    {
        private readonly FretCloudDBContext _context;

        public ApplyPerMasterController(FretCloudDBContext context)
        {
            _context = context;
        }
        ...
        {
            var DemoCompany = await _context.ApplyPerMasters.ToListAsync();
