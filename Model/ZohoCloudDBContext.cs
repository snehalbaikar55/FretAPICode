...
public partial class ZohoCloudDBContext : DbContext
{
    public ZohoCloudDBContext()
    {
    }

    public ZohoCloudDBContext(DbContextOptions<ZohoCloudDBContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwCargo>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_Cargo");
            ...
            entity.Property(e => e.Notes)
                .HasMaxLength(200)
                .HasColumnName("notes");
            entity.Property(e => e.NotifyParty1)
                .HasMaxLength(100)
                .HasColumnName("notifyParty1");
            entity.Property(e => e.NotifyParty1AddressId).HasColumnName("notifyParty1AddressId");
            entity.Property(e => e.NotifyParty1Id).HasColumnName("notifyParty1Id");
            entity.Property(e => e.NotifyParty2AddressId).HasColumnName("notifyParty2AddressId");
            entity.Property(e => e.NotifyParty2Id).HasColumnName("notifyParty2Id");
